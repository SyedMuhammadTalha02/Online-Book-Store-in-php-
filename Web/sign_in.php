        ...
        if ($stmt) {
            ...
            if ($row = mysqli_fetch_assoc($result)) {
                ...
                if ($_SESSION['user_role'] === "Admin") {
                    ...
                    header("Location: sign_in.php?error=invalidrole");
                    exit();
                }
            } else {
...
<body>
    ...
    <div class="box-root flex-flex flex-direction--column" style="min-height: 100vh;flex-grow: 1;">
      ...
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center" >
            <a href="" class="text-decoration-none" style="position: absolute;">
                <span class="h1 text-uppercase text-primary bg-dark px-2" style="background-color:#555555; color:yellow; padding:10px; font-size:40px; ">E BOOK</span>
          ...
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              ...
              <form method="post" onsubmit="return validation()">
                ...
                <div class="field">
                  <a class="ssolink" href="#" style="color: black;">Use single sign-on (Google) instead</a>
                </div>
              </form>
            </div>
          </div>
          <div class="footer-link padding-top--24">
            <span>Don't have an account? <a href="sign_up.php" style="color: black;">Sign up</a></span>
  ...
  <script>
      ...
      function validation() {
        ...
        let userCheck = /^[A-Za-z_ ]{2,}$/;
        // let passCheck = /^(?=.*[A-Za-z])(?=.*[0-9])(?=.*[!@#$%^&*])[A-Za-z0-9!@#$%^&*]$/;
        ...
        {
          document.getElemenetById("pError").innerHTML="";
        }else{
