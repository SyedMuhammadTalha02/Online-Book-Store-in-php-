...
<body>
      ...
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center" >
                ...
                <a href="" class="text-decoration-none" style="position: absolute;">
                    <span class="h1 text-uppercase text-primary bg-dark px-2" >E BOOK</span>
        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              ...
              <form method="POST" action="signup_process.php" enctype="multipart/form-data" onsubmit="return validationForm()">
        ...
        <input type="email" name="email" id="email" required>
                ...
                <div class="field padding-bottom--24">
                  ...
                  <span id="ePass" style="color:red;"></span>
                </div>
                <div class="field padding-bottom--24">
          ...
          <div class="footer-link padding-top--24">
            <span>Don't have an account? <a href="sign_in.php" style="color: black;">Sign in</a></span>
  ...
  <script>
    ...
    function validationForm() {
      ...
      let emailCheck = /^[A-Za-z0-9_]+@[A-Za-z]+\.[A-Za-z]{2,}$/;
      // let passCheck = /^(?=.*[A-Za-z])(?=.*[0-9])(?=.*[!@#$%^&*])[A-Za-z0-9!@#$%^&*]{8,}$/;
